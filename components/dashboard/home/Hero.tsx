  ...
  return (
    <section className="rounded-3xl bg-gradient-to-r from-violet-600 to-purple-600 p-8 text-white shadow-lg">
      ...
      <p className="mt-2 max-w-xl text-violet-100">
        You have{" "}
        <strong>{data?.stats?.totalDocuments}</strong> document(s) uploaded,
        using <strong>{data?.stats?.totalStorage}</strong> storage.
      </p>

      <div className="mt-8 flex flex-wrap gap-6">
        <div className="rounded-2xl bg-white/10 px-5 py-4">
          <p className="text-sm text-violet-100">Documents</p>
        ...
        <div className="rounded-2xl bg-white/10 px-5 py-4">
          <p className="text-sm text-violet-100">Storage</p>
          <h3 className="text-2xl font-bold">
        ...
        <div className="rounded-2xl bg-white/10 px-5 py-4">
          <p className="text-sm text-violet-100">Recent Upload</p>
